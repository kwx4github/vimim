...
.. sidebar::  VimIM `〖云〗输入`_ 智能ABC双拼

   .. figure:: vimim_cloud_abc.gif
...
:答: | VimIM 不过是给 vim 玩家提供的一个 yet another 选择。
     ...
     | (6) VimIM 可随意扩展：看看我们刚刚上市的VimIM `〖云〗输入`_
     |
